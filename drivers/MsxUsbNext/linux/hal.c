...
{
    // setup serial 
    // crisag port to linux
    // check which serial tty your arduino is using and create a link to /dev/msxusb using
    // ln /dev/ttyACM1 /dev/msxusb (note that in this case my arduino is using /dev/ttyACM1)
    char device[] = "/dev/msxusb";
