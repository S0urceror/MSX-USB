...
## PCB
Please use the rev4 PCB by @cristianoag. This fits in a Konami style cartridge case and has a switch to select between two ROM images. Also use the rev4 CPLD code to enable this feature.
